# audio-dataset-converter 0.0.1 (based on code in repos)
...
* Execute commands
  ...
  docker tag \
      ...
      harbor.cms.waikato.ac.nz/public/tools/audio-dataset-converter:0.0.1
      
  docker push harbor.cms.waikato.ac.nz/public/tools/audio-dataset-converter:0.0.1
  ```
...
docker run --rm -u $(id -u):$(id -g) \
    ...
    -it harbor.cms.waikato.ac.nz/public/tools/audio-dataset-converter:0.0.1
```
